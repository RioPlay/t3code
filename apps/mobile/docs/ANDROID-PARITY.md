...
EXPO_PUBLIC_NATIVE_COMPOSER=1          # opt into native composer on Android (scaffold)
```
...
| `t3-composer-editor` | Scaffold (in progress) | Kotlin `EditText` scaffold; gated by `EXPO_PUBLIC_NATIVE_COMPOSER=1` |
