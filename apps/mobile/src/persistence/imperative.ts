...
export const replaceSavedConnections = (
  connections: ReadonlyArray<
    Parameters<MobileStorage.MobileStorage["Service"]["saveConnection"]>[0]
  >,
) => runStorage((storage) => storage.replaceSavedConnections(connections));
